...
public class DownloaderTaskFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ArrayList<Integer> args = bundle.getIntegerArrayList(MainActivity.TAG_FRIEND_RES_IDS);

		// TODO: Start the DownloaderTask
		dt.execute(args.toArray(new Integer[0]));
	}
	...
	public class DownloaderTask extends AsyncTask<Integer, Integer, String[]> {
		...
		protected void onPostExecute(String[] result) {
			if (mCallback != null) mCallback.notifyDataRefreshed(result);
		}
						...
						public void onReceive(Context context, Intent intent) {
							...
							if (getResultCode() != MainActivity.IS_ALIVE) {
								...
								Notification.Builder notificationBuilder = new Notification.Builder(
										context)
										.setTicker(mContext.getString(R.string.alert_string))
